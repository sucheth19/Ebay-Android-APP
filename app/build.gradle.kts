...
plugins {
    kotlin("android") version "1.8.10" // Use the latest version
    id("com.android.application")
}


android {
    namespace = "com.example.ebayhw4"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.ebayhw4"
        minSdk = 31
...
//    implementation("androidx.compose.ui:ui-tooling-preview")
    ...
    implementation("com.squareup.picasso:picasso:2.8.0") // Use the latest version
